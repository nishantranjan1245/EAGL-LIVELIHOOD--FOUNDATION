...
<section className="relative min-h-screen flex items-center justify-center overflow-hidden">
  ...
  <div className="absolute inset-0 z-0">
    ...
    {/* Gradient Orbs */}
    <motion.div
      className="absolute top-1/4 left-1/4 w-80 h-80 md:w-[400px] md:h-[400px] bg-gradient-to-br from-emerald-400/30 to-teal-500/30 rounded-full blur-3xl"
      animate={{ 
        scale: [1, 1.3, 1], 
        x: [0, 50, 0],
        y: [0, -50, 0],
    ...
    />
    <motion.div
      className="absolute bottom-1/4 right-1/4 w-80 h-80 md:w-[400px] md:h-[400px] bg-gradient-to-br from-cyan-400/30 to-blue-500/30 rounded-full blur-3xl"
      animate={{ 
        scale: [1.3, 1, 1.3], 
        x: [0, -50, 0],
        y: [0, 50, 0],
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
    <motion.h1
      className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 bg-gradient-to-r from-emerald-200 via-teal-100 to-cyan-200 bg-clip-text text-transparent"
    ...
    <motion.p
      className="text-lg md:text-2xl lg:text-3xl text-cyan-50 mb-12 max-w-3xl mx-auto font-bold"
      initial={{ opacity: 0, y: 30 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 1, delay: 1 }}
    >
      EAGL Livelihood Foundation is dedicated to <span className="text-emerald-300 font-black">protecting the environment</span>, <span className="text-teal-300 font-black">combating climate change</span>, and building <span className="text-cyan-300 font-black">climate-resilient communities</span>.
    </motion.p>
    <motion.div
    ...
    >
      <Button className="bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 text-white px-10 py-4 font-bold shadow-md hover:scale-105 transition-transform">
        Support Our Work
      </Button>
      <Button className="bg-white/20 text-white px-10 py-4 font-bold shadow-md hover:scale-105 transition-transform">
        Join as Volunteer
      </Button>
    </motion.div>
  </div>
  ...
  >
    <div className="w-8 h-14 border-3 border-white/60 rounded-full flex items-start justify-center p-2">
      <motion.div
    ...
    <p className="text-white text-xs mt-2 font-bold text-center">Scroll Down</p>
  </motion.div>
</section>
