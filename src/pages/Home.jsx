...
<section className="relative min-h-screen flex items-center justify-center overflow-hidden">
  ...
  <div className="absolute inset-0 z-0">
    ...
    <div className="hidden md:block">
      ...
      {/* Subtle Orbs */}
      <motion.div
        className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-gradient-to-br from-emerald-400/30 to-teal-500/30 rounded-full blur-3xl"
        animate={{ 
          x: [0, 40, 0],
          y: [0, -40, 0],
          opacity: [0.3, 0.5, 0.3]
      ...
      />
      <motion.div
        className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-gradient-to-br from-cyan-400/30 to-blue-500/30 rounded-full blur-3xl"
        animate={{ 
          x: [0, -40, 0],
          y: [0, 40, 0],
          opacity: [0.3, 0.5, 0.3]
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
    {/* keep your same text and buttons here */}
  </div>
