...
<section className="relative min-h-screen flex items-center justify-center overflow-hidden">
  ...
  <div className="absolute inset-0 z-0 pointer-events-none will-change-transform">
    ...
    <svg className="absolute inset-0 w-full h-full opacity-10 hidden sm:block">
      <defs>
        <pattern id="geo" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          <circle cx="50" cy="50" r="30" fill="none" stroke="#10b981" strokeWidth="1.5" />
          <polygon points="50,20 80,80 20,80" fill="none" stroke="#14b8a6" strokeWidth="1.5" />
        </pattern>
      </defs>
      <rect width="100%" height="100%" fill="url(#geo)" />
    </svg>

    {/* Gradient Orbs (kept simple for mobile performance) */}
    <motion.div
      className="absolute top-1/4 left-1/4 w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-gradient-to-br from-emerald-400/30 to-teal-500/30 rounded-full blur-3xl"
      animate={{
        scale: [1, 1.2, 1],
        opacity: [0.3, 0.6, 0.3],
        x: [0, 40, 0],
    ...
    />
    <motion.div
      className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] bg-gradient-to-br from-cyan-400/30 to-blue-500/30 rounded-full blur-3xl"
      animate={{
        scale: [1.2, 1, 1.2],
        opacity: [0.5, 0.3, 0.5],
        x: [0, -40, 0],
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
    ...
    >
      <div className="flex items-center justify-center gap-3 mb-8">
        ...
        <span className="text-emerald-200 font-black text-xl sm:text-2xl tracking-wide drop-shadow-2xl">
      ...
      <h1 className="font-black leading-tight mb-6">
        <span className="text-4xl sm:text-6xl md:text-7xl bg-gradient-to-r from-emerald-200 via-teal-100 to-cyan-200 bg-clip-text text-transparent drop-shadow-2xl">
          Together for a Greener, Sustainable Tomorrow
        </span>
      </h1>

      <p className="text-lg sm:text-2xl text-cyan-50 mb-12 leading-relaxed font-bold drop-shadow-2xl max-w-4xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          <Button
            asChild
            size="lg"
            className="bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 hover:from-emerald-600 hover:via-teal-600 hover:to-cyan-600 text-white text-xl px-10 py-6 shadow-xl hover:shadow-emerald-500/50 font-black border-2 border-white/30"
          >
            <Link to={createPageUrl("GetInvolved")}>
              <Heart className="w-6 h-6 mr-2" /> 🌱 Support Our Work
            </Link>
          </Button>
        </motion.div>
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          <Button
            asChild
            size="lg"
            className="bg-white/15 backdrop-blur-md border-2 border-white text-white hover:bg-white hover:text-emerald-700 text-xl px-10 py-6 font-black shadow-xl hover:shadow-white/50"
          >
            <Link to={createPageUrl("GetInvolved")}>
              <Users className="w-6 h-6 mr-2" /> 🤝 Join as Volunteer
            </Link>
          </Button>
        </motion.div>
      </div>
